 ...
 * tap here — the browser blocks autoplay-with-sound anyway, and starting
 * audio automatically would be a poor experience regardless.
 */
export const NasheedPlayerButton: React.FC = () => {
  const { isPlaying, isMuted, currentTrackTitle, hasTracks, toggle, toggleMute } = useAudioPlayer();
  ...
  return (
    <div className="fixed left-4 sm:left-6 bottom-4 sm:bottom-6 z-40 flex items-center gap-2">
      {expanded && (
        <div className="bg-[#0E0C0A] text-white px-4 py-2.5 shadow-lg border border-white/10 flex items-center gap-3 max-w-[220px]">
